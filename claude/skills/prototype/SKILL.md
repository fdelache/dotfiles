---
name: prototype
description: Enter prototype mode - embrace shortcuts, skip tests, capture learnings automatically. Use when the user says "prototype mode", "let's prototype", "rapid experiment", "spike", "hack on this", or wants to explore system capabilities without production concerns.
---
